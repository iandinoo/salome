...
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://nuriadeviana:itsiannnn@dinorare.ocngf.mongodb.net/?retryWrites=true&w=majority&appName=DinoRARE")
DB_NAME = os.environ.get("DATABASE_NAME", "DinoRARE")
